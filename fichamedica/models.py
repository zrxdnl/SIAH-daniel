...
from verificacao.validator import validate_hora, validate_data, validate_sus, validate_digits, validate_localizacao, validate_numerodocumento
class Fichamedica(models.Model): 
     ...
     Numero_SUS = models.ForeignKey(Paciente,null = False, on_delete=models.CASCADE, related_name='SUS') 
