...
from verificacao.validator import validate_hora, validate_no_digits, validate_data, validate_sus, validate_digits, validate_localizacao, validate_numerodocumento
