...
from verificacao.validator import validate_no_digits, validate_digits, validate_cep, validate_cnes, validate_cnpj

class Unidade(models.Model):
     nome_unidade = models.CharField(max_length=256, validators=[validate_no_digits])
     cnes = models.CharField(max_length=7, validators=[validate_digits, validate_cnes])
     cnpj = models.CharField(max_length=14, validators=[validate_cnpj, validate_digits])
     ...
     estado_unidade = models.CharField(max_length=10, validators=[validate_no_digits])
